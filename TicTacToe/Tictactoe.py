...
# x starts with clicked being true
count = 0
...
def b_click(b):
    ...
    if b["text"]==" " and clicked==True:
        ...
        messagebox.showerror("Tic Tac Toe", "That box is already taken, choose another square!")
...
def checkifwon():
    ...
    if b1["text"] == "X" and b2["text"] == "X" and b3["text"] == "X":
        ...
        winner = True
        messagebox.showinfo("Tic Tac Toe", "Congradulation X Won!")
        disable_all_buttons()
        ...
        b3.config(bg="red") , b5.config(bg="red") , b7.config(bg="red") 
        winner = True
        messagebox.showinfo("Tic Tac Toe", "Congradulation X Won!")
        disable_all_buttons()
    ...
    if b1["text"] == "O" and b2["text"] == "O" and b3["text"] == "O":
        b1.config(bg="red") , b2.config(bg="red") , b3.config(bg="red") 
        winner = True
        messagebox.showinfo("Tic Tac Toe", "Congradulation O Won!")
        disable_all_buttons()
        ...
        messagebox.showinfo("Tik tac toe", "It is a tie, play again to determine a winner!")
...
my_menu.add_cascade(label="Optios", menu=options_menu)
